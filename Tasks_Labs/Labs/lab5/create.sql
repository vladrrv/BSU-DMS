...
/*         премия                     */
/******************************************************/
create table bonus (empno integer references emp(empno) not null, month smallint check(month>0 and month<13), year integer check(year>2013 and year<2019), bonvalue real, tax real);
commit;
