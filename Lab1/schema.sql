...
(
	...
	Transfer_Cost        DECIMAL(19,4) NULL  CONSTRAINT  TransferCostConstraint CHECK (Transfer_Cost >= 0)
);
...
(
	...
	Living_Cost          DECIMAL(19,4) NULL  CONSTRAINT  CostConstraint2 CHECK (Living_Cost >= 0),
...
(
	...
	Customer_id          INT NULL ,
	Cost                 DECIMAL(19,4) NULL  CONSTRAINT  CostConstraint CHECK (Cost >= 0)
);
...
(
	id                   INT NOT NULL ,
	Country_id           INT NOT NULL ,
	Type                 CHAR(18) NULL  CONSTRAINT  TourTypeConstraint CHECK (Type IN ('relax', 'trip', 'hunt', 'fish')),
